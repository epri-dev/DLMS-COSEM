...
namespace EPRI
{
    ...
    APDUConstants::Data_Access_Result STM32Data::InternalGet(ICOSEMAttribute * pAttribute, 
    ...
    APDUConstants::Data_Access_Result STM32Data::InternalSet(ICOSEMAttribute * pAttribute, 
        const Cosem_Attribute_Descriptor& Descriptor, 
    ...
    APDUConstants::Data_Access_Result STM32Clock::InternalGet(ICOSEMAttribute * pAttribute, 
        const Cosem_Attribute_Descriptor& Descriptor, 
        SelectiveAccess * pSelectiveAccess)
    {
    ...
    APDUConstants::Action_Result STM32Clock::InternalAction(ICOSEMMethod * pMethod, 
